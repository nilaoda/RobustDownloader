...
public static class LocalizationService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> ZhHans = new Dictionary<string, string>
    {
        ...
        ["Main.SpeedLimit"] = "限速",
        ["Main.SpeedLimitUnit"] = "MB/s",
        ["Main.SpeedLimitStatus"] = "限速 {0}/s",
        ["Main.Concurrency"] = "并发",
        ["Main.StartAll"] = "全部开始",
        ["Main.StopAll"] = "全部停止",
        ["Main.Settings"] = "设置",
        ...
        ["Main.ShowTaskTree"] = "显示分类",
        ["Main.HideTaskTree"] = "隐藏分类",
        ["Main.CollapseDetails"] = "收起",
        ["Main.EmptyTitle"] = "还没有下载任务",
        ["Main.EmptyBody"] = "添加一个 URL 或批量粘贴多行链接后，队列会显示下载进度、速度和状态。",
        ["Main.EmptyFilterTitle"] = "当前筛选没有任务",
        ["Main.EmptyFilterBody"] = "切换左侧分类或上方范围后，可查看其它任务。",
        ...
        ["Main.ReDownload"] = "重新下载",
        ["Main.ReDownloadQueued"] = "已加入重新下载队列",
        ["Main.ReDownloadFailed"] = "重新下载失败: {0}",
        ["Main.Overview"] = "概览",
        ["Main.Log"] = "日志",
        ["Main.Headers"] = "Header",
        ["Main.RecentLog"] = "最近日志",
...
""",
        ...
        ["Cli.Error.InvalidSaveDir"] = "无效的保存目录 {0}: {1}",
        ...
        ["TaskTree.Title"] = "任务分类",
        ["TaskTree.All"] = "所有任务",
        ["TaskTree.Completed"] = "已完成",
        ["TaskTree.Incomplete"] = "未完成",
        ["TaskTree.NoExtension"] = "无扩展名",
        ["TaskTree.NodeLabel"] = "{0} ({1})",
        ["Column.FileName"] = "文件名",
        ["Column.Status"] = "状态",
        ["Column.Progress"] = "进度",
        ["Column.Speed"] = "速度",
        ...
        ["Add.Urls"] = "下载地址",
        ["Add.UrlsWithCount"] = "下载地址（共 {0} 条）",
        ["Add.UrlsHint"] = "一行一个 URL。单个 URL 可手动覆盖文件名，批量任务会自动识别文件名。",
        ["Add.SaveDirectory"] = "保存目录",
        ["Add.Browse"] = "选择",
        ["Add.FileName"] = "文件名",
        ["Add.FileNameHint"] = "仅在输入单个 URL 时可编辑。",
        ["Add.BatchNaming"] = "批量文件命名",
        ["Add.BatchNamingMode"] = "命名方式",
        ["Add.BatchNamingAuto"] = "自动识别",
        ["Add.BatchNamingTemplate"] = "自定义模板",
        ["Add.BatchTemplate"] = "文件名模板",
        ["Add.BatchTemplateHint"] = "# 表示编号，* 表示自动识别出的文件名，例如 文件_#_*。",
        ["Add.BatchStart"] = "起始数字",
        ["Add.BatchStep"] = "步长",
        ["Add.BatchDigits"] = "位数",
        ["Add.BatchPreview"] = "预览",
        ...
        ["Validation.BatchTemplate"] = "批量命名模板不能为空。",
        ["Validation.BatchStart"] = "起始数字必须是大于或等于 0 的整数。",
        ["Validation.BatchStep"] = "步长必须是大于 0 的整数。",
        ["Validation.BatchDigits"] = "位数必须是大于 0 的整数。",
        ["Validation.BatchFileName"] = "生成的文件名不能为空，且不能包含非法字符。",
        ["Validation.BatchDuplicateFileName"] = "模板生成了完全相同的文件名，请加入 # 编号或调整模板。",
        ["Settings.Title"] = "全局设置",
        ...
        ["Settings.WindowBehavior"] = "窗口关闭行为",
        ["Settings.CloseToTray"] = "关闭到托盘/菜单栏",
        ["Settings.CloseToExit"] = "直接退出软件",
        ["Settings.ConfirmCloseToTray"] = "关闭到托盘/菜单栏前显示确认",
        ["Settings.WindowBehaviorHint"] = "选择关闭窗口按钮是隐藏到后台继续运行，还是直接退出软件。",
        ...
        ["Settings.SpeedLimit"] = "全局下载限速",
        ["Settings.SpeedLimitEnable"] = "启用限速",
        ["Settings.SpeedLimitUnit"] = "MB/s",
        ["Settings.SpeedLimitHint"] = "限制所有正在下载任务共享的总下载速度，可拖动滑块或手动输入 0.1 到 100 之间的数值。",
        ...
        ["Validation.SpeedLimit"] = "限速必须是大于 0 的数字。",
        ...
        ["Tray.Hide"] = "隐藏主窗口",
        ["Tray.Exit"] = "退出",
        ["CloseDialog.Title"] = "关闭 RobustDownloader？",
        ["CloseDialog.Message.Tray"] = "关闭窗口后，下载队列会继续在系统托盘中运行。",
        ["CloseDialog.Message.MenuBar"] = "关闭窗口后，下载队列会继续在菜单栏中运行。",
        ["CloseDialog.MinimizeToTray"] = "关闭到托盘",
        ["CloseDialog.MinimizeToMenuBar"] = "关闭到菜单栏",
        ["CloseDialog.Exit"] = "退出软件",
        ["CloseDialog.Cancel"] = "取消",
        ["CloseDialog.DoNotAskAgain"] = "不再询问并记住我的选择",
    ...
    private static readonly IReadOnlyDictionary<string, string> En = new Dictionary<string, string>
    {
        ...
        ["Main.SpeedLimit"] = "Speed limit",
        ["Main.SpeedLimitUnit"] = "MB/s",
        ["Main.SpeedLimitStatus"] = "Limited to {0}/s",
        ...
        ["Main.ShowTaskTree"] = "Show Tree",
        ["Main.HideTaskTree"] = "Hide Tree",
        ...
        ["Main.EmptyFilterTitle"] = "No tasks match this filter",
        ["Main.EmptyFilterBody"] = "Switch the category on the left or change the range above to view other tasks.",
...
""",
        ...
        ["Cli.Error.InvalidSaveDir"] = "Invalid save directory {0}: {1}",
        ...
        ["Main.ReDownloadFailed"] = "Re-download failed: {0}",
        ...
        ["TaskTree.All"] = "All Tasks",
        ["TaskTree.Completed"] = "Completed",
        ["TaskTree.Incomplete"] = "Incomplete",
        ["TaskTree.NoExtension"] = "No Extension",
        ["TaskTree.NodeLabel"] = "{0} ({1})",
        ...
        ["Add.UrlsWithCount"] = "Download URLs ({0} total)",
        ...
        ["Add.BatchNaming"] = "Batch File Naming",
        ["Add.BatchNamingMode"] = "Naming Mode",
        ["Add.BatchNamingAuto"] = "Auto Detect",
        ["Add.BatchNamingTemplate"] = "Custom Template",
        ["Add.BatchTemplate"] = "File Name Template",
        ["Add.BatchTemplateHint"] = "# inserts the number, * inserts the auto-detected file name, for example File_#_*.",
        ["Add.BatchStart"] = "Start",
        ["Add.BatchStep"] = "Step",
        ["Add.BatchDigits"] = "Digits",
        ["Add.BatchPreview"] = "Preview",
        ...
        ["Validation.BatchTemplate"] = "The batch naming template cannot be empty.",
        ["Validation.BatchStart"] = "Start must be an integer greater than or equal to 0.",
        ["Validation.BatchStep"] = "Step must be an integer greater than 0.",
        ["Validation.BatchDigits"] = "Digits must be an integer greater than 0.",
        ["Validation.BatchFileName"] = "Generated file names cannot be empty or contain invalid characters.",
        ["Validation.BatchDuplicateFileName"] = "The template generated duplicate file names. Add # numbering or adjust the template.",
        ...
        ["Settings.WindowBehavior"] = "Window Close Behavior",
        ["Settings.CloseToTray"] = "Close to tray / menu bar",
        ["Settings.CloseToExit"] = "Exit application",
        ["Settings.ConfirmCloseToTray"] = "Confirm before closing to tray / menu bar",
        ["Settings.WindowBehaviorHint"] = "Choose whether the window close button hides the app in the background or exits it.",
        ...
        ["Settings.SpeedLimit"] = "Global Download Speed Limit",
        ["Settings.SpeedLimitEnable"] = "Enable speed limit",
        ["Settings.SpeedLimitUnit"] = "MB/s",
        ["Settings.SpeedLimitHint"] = "Limit the total shared download speed across all running tasks. Drag the slider or enter a value from 0.1 to 100.",
        ...
        ["Validation.SpeedLimit"] = "Speed limit must be a number greater than 0.",
        ...
        ["Tray.Exit"] = "Exit",
        ["CloseDialog.Title"] = "Close RobustDownloader?",
        ["CloseDialog.Message.Tray"] = "The download queue will keep running in the system tray after the window is closed.",
        ["CloseDialog.Message.MenuBar"] = "The download queue will keep running in the menu bar after the window is closed.",
        ["CloseDialog.MinimizeToTray"] = "Close to Tray",
        ["CloseDialog.MinimizeToMenuBar"] = "Close to Menu Bar",
        ["CloseDialog.Exit"] = "Exit",
        ["CloseDialog.Cancel"] = "Cancel",
        ["CloseDialog.DoNotAskAgain"] = "Do not ask again and remember my choice",
    ...
    private static readonly IReadOnlyDictionary<string, string> ZhHant = new Dictionary<string, string>
    {
        ...
        ["Main.ShowTaskTree"] = "顯示分類",
        ["Main.HideTaskTree"] = "隱藏分類",
        ["Main.CollapseDetails"] = "收起",
        ["Main.EmptyTitle"] = "還沒有下載任務",
        ["Main.EmptyBody"] = "新增一個 URL 或批次貼上多行連結後，佇列會顯示下載進度、速度和狀態。",
        ["Main.EmptyFilterTitle"] = "目前篩選沒有任務",
        ["Main.EmptyFilterBody"] = "切換左側分類或上方範圍後，可查看其他任務。",
...
""",
        ...
        ["Cli.Error.InvalidSaveDir"] = "無效的儲存目錄 {0}: {1}",
        ...
        ["Main.ReDownloadFailed"] = "重新下載失敗: {0}",
        ["Main.Overview"] = "概覽",
        ["Main.Log"] = "日誌",
        ["Main.Headers"] = "Header",
        ["Main.RecentLog"] = "最近日誌",
        ...
        ["Add.Urls"] = "下載地址",
        ["Add.UrlsWithCount"] = "下載地址（共 {0} 筆）",
        ["Add.UrlsHint"] = "一行一個 URL。單一 URL 可手動覆寫檔名；批次任務會自動識別檔名。",
        ["Add.SaveDirectory"] = "儲存目錄",
        ["Add.Browse"] = "選擇",
        ["Add.FileName"] = "檔名",
        ["Add.FileNameHint"] = "僅在輸入單一 URL 時可編輯。",
        ["Add.BatchNaming"] = "批次檔名命名",
        ["Add.BatchNamingMode"] = "命名方式",
        ["Add.BatchNamingAuto"] = "自動識別",
        ["Add.BatchNamingTemplate"] = "自訂模板",
        ["Add.BatchTemplate"] = "檔名模板",
        ["Add.BatchTemplateHint"] = "# 表示編號，* 表示自動識別出的檔名，例如 檔案_#_*。",
        ["Add.BatchStart"] = "起始數字",
        ["Add.BatchStep"] = "步長",
        ["Add.BatchDigits"] = "位數",
        ["Add.BatchPreview"] = "預覽",
        ...
        ["Validation.BatchTemplate"] = "批次命名模板不能為空。",
        ["Validation.BatchStart"] = "起始數字必須是大於或等於 0 的整數。",
        ["Validation.BatchStep"] = "步長必須是大於 0 的整數。",
        ["Validation.BatchDigits"] = "位數必須是大於 0 的整數。",
        ["Validation.BatchFileName"] = "產生的檔名不能為空，且不能包含非法字元。",
        ["Validation.BatchDuplicateFileName"] = "模板產生了完全相同的檔名，請加入 # 編號或調整模板。",
        ["Settings.Title"] = "全域設定",
        ...
        ["Settings.ThemeDark"] = "深色",
        ["Settings.WindowBehavior"] = "視窗關閉行為",
        ["Settings.CloseToTray"] = "關閉到托盤/選單列",
        ["Settings.CloseToExit"] = "直接退出軟體",
        ["Settings.ConfirmCloseToTray"] = "關閉到托盤/選單列前顯示確認",
        ["Settings.WindowBehaviorHint"] = "選擇關閉視窗按鈕是隱藏到背景繼續執行，還是直接退出軟體。",
        ...
        ["Settings.SpeedLimit"] = "全域下載限速",
        ["Settings.SpeedLimitEnable"] = "啟用限速",
        ["Settings.SpeedLimitUnit"] = "MB/s",
        ["Settings.SpeedLimitHint"] = "限制所有正在下載任務共享的總下載速度，可拖動滑桿或手動輸入 0.1 到 100 之間的數值。",
        ...
        ["Validation.SpeedLimit"] = "限速必須是大於 0 的數字。",
        ...
        ["Tray.Hide"] = "隱藏主視窗",
        ["Tray.Exit"] = "退出",
        ["CloseDialog.Title"] = "關閉 RobustDownloader？",
        ["CloseDialog.Message.Tray"] = "關閉視窗後，下載佇列會繼續在系統托盤中執行。",
        ["CloseDialog.Message.MenuBar"] = "關閉視窗後，下載佇列會繼續在選單列中執行。",
        ["CloseDialog.MinimizeToTray"] = "關閉到托盤",
        ["CloseDialog.MinimizeToMenuBar"] = "關閉到選單列",
        ["CloseDialog.Exit"] = "退出軟體",
        ["CloseDialog.Cancel"] = "取消",
        ["CloseDialog.DoNotAskAgain"] = "不再詢問並記住我的選擇",
